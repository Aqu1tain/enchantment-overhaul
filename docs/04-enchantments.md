...
|---|---|---|---|
| Fire Aspect | II | Sword/Spear | Ignite target, +4s burn/level |
| Flame | I | Bow | Arrows ignite target |
| Channeling | I | Trident | Summon lightning during storms |
| Frost Walker | II | Boots | Water freezes under feet |
| Thorns | III | Armor | Level x 15% chance to deal 1-5 HP |
| Fortune | III | Pickaxe | Multiply ore drops |
| Looting | III | Sword/Spear | +1 max drop per level |
| Silk Touch | I | Tools | Blocks drop themselves |
| Luck of the Sea | III | Fishing Rod | Increase treasure finds |
| Infinity | I | Bow | Arrows not consumed |
| Depth Strider | III | Boots | Reduce water slowdown |
| Soul Speed | III | Boots | Speed on Soul Sand |
| Swift Sneak | III | Leggings | +15% sneak speed/level |
| Riptide | III | Trident | Launch in water/rain |
| Loyalty | III | Trident | Trident returns after throw |
| Multishot | I | Crossbow | Fire 3 arrows for 1 |
| Piercing | IV | Crossbow | Arrows pass through entities |
| Wind Burst | III | Mace | Wind burst on impact |
| Respiration | III | Helmet | +15s breath/level |
...
| Enchantment | Max | Item | Effect |
|---|---|---|---|
| Veil | I | Helmet | Mobs detect much closer, nametag hidden through walls |
| Last Stand | III | Chestplate | Below 20% HP, damage reduced 10%/level |
| Step-Up | I | Boots | Walk up 1-block heights without jumping |
| Buoyancy | I | Boots | Float on water surface |
| Venom | II | Sword/Spear | Apply Poison I for 4/6 seconds |
| Magnetic | III | Pick/Shovel/Hoe | Drops teleported within 3/5/8 blocks |
| Molten | I | Pickaxe | Mined blocks auto-smelt, disabled while sneaking |
| Reach | III | Any tool | +1 block interaction range per level |
| Homing | I | Crossbow | Bolts slightly track nearest entity |
| Soulbound | I | Any | Stays in inventory on death, exclusive with Mending |
| Curse of Fragility | I | Any | Double durability damage → +1 slot |
| Curse of Hunger | I | Armor | 30% faster hunger → +1 slot |

## Removed Enchantments

| Enchantment | Destination | Reason |
|---|---|---|
| Protection I-IV | Smithing (Warding) | Stat boost |
...
| Density I-V | Smithing (Honing) | Stat boost |
...
| Buoyancy | Kelp |
| Venom | Spider Eye |
| Magnetic | Iron Nugget |
| Molten | Magma Cream |
| Reach | Ender Pearl |
| Homing | Eye of Ender |
| Soulbound | Totem of Undying |
| Curse of Fragility | Prismarine Shard |
| Curse of Hunger | Rotten Flesh |
| Curse of Binding | Chain |
| Curse of Vanishing | Phantom Membrane |

## Book Sources by Structure

| Enchantment | Structure |
|---|---|
| Fire Aspect | Nether Fortress |
| Flame | Nether Fortress |
| Channeling | Desert Temple |
| Frost Walker | Igloo |
| Thorns | Jungle Temple |
| Fortune | Mineshaft |
| Looting | Pillager Outpost |
| Silk Touch | Mineshaft |
| Luck of the Sea | Shipwreck |
| Infinity | Stronghold |
| Depth Strider | Ocean Ruins |
| Soul Speed | Bastion Remnant |
| Swift Sneak | Ancient City |
| Riptide | Ocean Monument |
| Loyalty | Shipwreck |
| Multishot | Pillager Outpost |
| Piercing | Pillager Outpost |
| Wind Burst | Trial Chambers |
| Respiration | Ocean Ruins |
| Aqua Affinity | Ocean Ruins |
| Sweeping Edge | Woodland Mansion |
...
| Step-Up | Village (Rare) |
| Buoyancy | Shipwreck |
| Venom | Nether Fortress |
| Magnetic | Mineshaft |
| Molten | Nether Fortress |
| Reach | End City |
| Homing | Pillager Outpost |
| Soulbound | Stronghold |
| Curse of Fragility | Desert Temple |
| Curse of Hunger | Woodland Mansion |
| Curse of Binding | Ancient City |
| Curse of Vanishing | Jungle Temple |
