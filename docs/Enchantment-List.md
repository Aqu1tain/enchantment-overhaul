...
|---|---|---|---|
| Curse of Binding | I | Armor | Cannot remove armor, +1 slot |
| Curse of Vanishing | I | Any | Item disappears on death, +1 slot |
| Fire Aspect | II | Sword/Spear | Ignite target |
...
| Thorns | III | Armor | Chance to deal damage to attackers |
...
| Swift Sneak | III | Leggings | Increased sneak speed |
...
| Respiration | III | Helmet | Extended underwater breathing |
| Aqua Affinity | I | Helmet | Normal mining underwater |
| Sweeping Edge | III | Sword | Increased sweep damage |
| Knockback | II | Sword/Spear | Push target back |
| Punch | II | Bow | Arrows push target back |
| Feather Falling | IV | Boots | Reduce fall damage, prevent crop trampling |
| Quick Charge | III | Crossbow | Reduce reload time |
| Lunge | III | Spear | Propel forward during jab |
...
These are replaced by the [[Smithing Table]] or [[Innate Material Properties]] systems.
...
| Power | Smithing (Honing) |
| Density | Smithing (Honing) |
| Impaling | Smithing (Honing) |
| Smite | Removed |
| Bane of Arthropods | Removed |
| Unbreaking | Smithing (Tempering) |
| Efficiency | Smithing (Grinding) |
