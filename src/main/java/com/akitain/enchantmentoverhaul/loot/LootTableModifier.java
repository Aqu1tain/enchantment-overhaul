...
public class LootTableModifier {
    ...
    private static final List<StructureLoot> STRUCTURE_LOOT = List.of(
            ...
            new StructureLoot("chests/woodland_mansion", 65, 12, List.of(
                    Enchantments.SWEEPING, Enchantments.LOOTING, ModEnchantments.CURSE_OF_HUNGER, Enchantments.SILK_TOUCH, Enchantments.THORNS, ModEnchantments.WRAITH)),
            ...
            new StructureLoot("chests/ancient_city", 50, 17, List.of(
                    ModEnchantments.VEIL, Enchantments.SWIFT_SNEAK, Enchantments.BINDING_CURSE, ModEnchantments.WRAITH)),
